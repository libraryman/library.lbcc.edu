...
<script>
  ...
  ga('send', 'pageview');
	...
	<script type="text/javascript" language="JavaScript" src="validate-formsnew.js"></script>
...
<h1>Library Forms:<br />Request a Book Transfer<br />From Other Campus</h1>
  
<h2 class="clear">Request a Book Transfer From Other Campus</h2> 

<div id="main-text">

<p>To request a book which is only available at a different LBCC campus to be transferred to the campus you use, 
...
Circulation Desk for the item.</p>
 ...
 <!-- *************************** start of form   ************************************* --> 
  ...
  <cfform name="myform" action="components/requestbookform.cfc?method=emailinformation" onsubmit="return validate();" method="post">        
  ...
  <fieldset>
  	...
  	<p>
  	<input type="radio" class="radio" checked="checked" name="campus" id="LAC" value="LAC" accesskey="b" />
  	<label for="LAC">LAC (please transfer to PCC for pickup)</label>
  	...
  	<p>
  	<label for="edition">Edition or Comments:</label>
 ...
 <fieldset>
    ...
    <p>
    <label for="id">Your I.D. Number:<span class="required">*</span></label>
...
<fieldset>
	...
	<input name="emaildefault" type="hidden" value="dlaney@lbcc.edu">
</fieldset>
