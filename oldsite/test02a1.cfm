...
<style>
        /* #ee2d24 is pantone 485 -- lbcc red */
    /* quick overrides */
...
.buttontext  a:link, a:visited, p {font-size:.8em; line-height:1em; padding-right:10px;color:#090909;}
...
#books {background-color:#fff;width:160px; background-image:url('images/new_index/book_gray.png'); background-repeat:no-repeat;margin-left:10px;}
a:hover #books {background-image:url('images/new_index/book_gray_light.png')}

#tbx {background-color:#fff;width:110px; background-image:url('images/new_index/txbks_gray.png'); background-repeat:no-repeat; }
a:hover #tbx {background-image:url('images/new_index/txbks_gray_light.png')}

#art {background-color:#fff;;width:160px;background-image:url('images/new_index/art_gray_alt.png'); background-repeat:no-repeat;}
a:hover #art {background-image:url('images/new_index/art_gray_light_alt.png')}

#gdes {background-color:#fff;width:160px;background-image:url('images/new_index/gdes_gray.png'); background-repeat:no-repeat;margin-left:-10px; }
a:hover #gdes {background-image:url('images/new_index/gdes_gray_light.png')}
