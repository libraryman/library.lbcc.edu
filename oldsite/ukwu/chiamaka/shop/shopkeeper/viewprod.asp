...
<%if page > 0 then%>window.location="listprods.asp?page=" +pid;<%else%>window.location="specialslist.asp";<%end if%>
}
...
<p class="smalltext">Shopkeeper Control Panel - Examine product</td>
</tr>
<tr>
<td width="100%">
<%if fail <> "true" then%>
<div class="normal" align="center"><b><u>Product  Category: <%=catname%></u></b></div>
<hr>
<div align="center">
...
<td width="34%" valign="top" class="smalltext" align="center">To make changes to
this product&nbsp;<br>
click 'Modify Product'</td>
<td width="33%" valign="top" class="smalltext" align="center"><%if page >0 then%>To return to lists click<%else%>Back to Specials<%end if%><br>
'Return'</td>
</tr>
<tr>
<td width="33%">
...
<td width="33%">
<div align="center"><input type="button" value="Return" name="B1" onclick="gotoresults(<%=page%>)"></div></td>
</tr>
</table>
</div>
</form>
