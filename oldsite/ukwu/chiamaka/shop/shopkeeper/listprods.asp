...
'bgcol = "#FF3300"
'
sql = "SELECT * FROM goods INNER JOIN cats ON goods.catid = cats.id ;"
iPageSize = 25
...
<tr>
<td width="100%">
<p class="normal">Here is a current list of products in your store.<br>
...
<input type="hidden" name="page" value="<%=ipagecurrent%>"></form>
</td></tr>
