...
<tr>
<td width="100%">
<form method="POST" action="accounts1.asp">
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
                  <td width="100%" colspan="2" class="smalltext"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">To 
                    view your account details please enter your email address 
                    and password</font></b></td>
</tr>
<tr>
                  <td width="43%"class="normal"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Email 
                    address</font></td>
<td width="57%"class="normal"><input type="text" name="email" size="20" style="font-family: Verdana; font-size: 8pt; letter-spacing: -1"></td>
</tr>
<tr>
                  <td width="43%"class="normal"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Password</font></td>
