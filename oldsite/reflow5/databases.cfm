...
<div class="container white">
    ...
    <div class="nine columns omega wheat toprow">
        ...
        <cfinclude template="inc/button_banner_inc.cfm">
<div id="macro_menu">              
  ...
  <div class="alpha nine columns databases_header"><div id="breadcrumb"><a href="index.cfm">Home</a>&nbsp;|&nbsp;Articles and eBooks</div><h1 class="banner_title">Articles and eBooks</h1></div>



        <div  class="body_copy">
 
                <p>You can find peer reviewed journal articles, encyclopedia articles, debate resources and more in the following databases are licensed for use by current students, faculty, and staff of Long Beach City College only and paid for by the Library. For off-campus access, click the link of the name of the database you would like to connect to and follow the login instructions.<br /><br /></p>

            <h2>Find Articles by Subject</h2>
            <h3>View by:&nbsp;<b>[subject]</b>&nbsp;&nbsp;<a href="databases.cfm?begins=A-B">[alphabetical]</a>&nbsp;&nbsp;<a href="databases.cfm">[popular]</a></h3>   
 
<div class="toggle-view">
            <h3>Multiple Database Search<br /></h3>
<div class="panel">                                
                         ...
                         <li>
                            ...
                            <div class="panel">
                             ...
                             <h3><a title="Health and Wellness Resource Center" href="http://lib-ezproxy.lbcc.edu:2048/login?url=http://infotrac.galegroup.com/itweb/cclc_lbcc?db=HWRC" target="_blank">Health and Wellness Resource Center (Gale)</a></h3>
                                <p>Includes all the contents of the Health Reference Center&emsp;Academic, as well as additional reference books, updated pamphlets, and Web links.<br />&nbsp;<br /></p>
                                <h3><a title="Health Reference Center - Academic" href="http://lib-ezproxy.lbcc.edu:2048/login?url=http://infotrac.galegroup.com/itweb/cclc_lbcc?db=HRCA" target="_blank">Health Reference Center &emsp; Academic (Gale)</a></h3>
