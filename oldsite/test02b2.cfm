...
#books {background-color:#fff;width:160px; background-image:url('images/new_index/book_gray_center.png'); background-repeat:no-repeat;margin-left:10px;}
a:hover #books {background-image:url('images/new_index/book_gray_light_center.png')}

#tbx {borderbackground-color:#fff;width:110px; background-image:url('images/new_index/txbks_gray_center.png'); background-repeat:no-repeat; }
a:hover #tbx {background-image:url('images/new_index/txbks_gray_light_center.png')}
#art {border:background-color:#fff;;width:160px;background-image:url('images/new_index/art_gray_alt_center.png'); background-repeat:no-repeat;}
a:hover #art {background-image:url('images/new_index/art_gray_light_alt_center.png')}
#gdes {background-color:#fff;width:160px;background-image:url('images/new_index/gdes_gray_center.png'); background-repeat:no-repeat;margin-left:-10px; }
a:hover #gdes {background-image:url('images/new_index/gdes_gray_light_center.png')}
    </style>
</head>
...
<h1><i>Find</i></h1>
        ...
        <div class="grid_3">
            <div class="bigbutton" id="books"> <h1>Books, Movies&hellip;</h1></div>
        ...
        <div class="grid_2">
            <div  class="bigbutton" id="tbx"><h1>Textbooks</h1></div>                      
        ...
        <div class="grid_3">
            <div class="bigbutton" id="art"><h1>Articles & eBooks</h1></div>
        ...
        <a href="http://lbcc.libguides.com">
            <div class="grid_3 omega">
                <div  class="bigbutton" id="gdes"><h1>Study Guides</h1></div>                       
