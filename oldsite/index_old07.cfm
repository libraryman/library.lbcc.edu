...
<div style="width:300px;float:left;padding:10px;"><h1><a href="boopsie.cfm">Try the LBCC Library mobile app</a></h1>

     <a href="boopsie.cfm"><img src="images/boopsie/boopsie_small.png" width="200" height="170" style="border:0px;" /></a>
<p>Public beta available now. Install and use your smartphone to use the Library!</p>
       
     </div>    
<div style="width:300px;float:right;padding:10px;">
    <h1><a href="website_test.cfm">Help test the new Library website!</a></h1>
<div style="float:right">
     <a href="website_test.cfm"><img src="images/webtest/red_rover.png" width="203" height="76" style="border:0px;" /></a>
    <p><a href="website_test.cfm">Find out more &hellip;</a></p>
    </div>     
     </div> 
    ...
    <div class="quicklinks"> 
        ...
        <h1><a href="workshops.cfm">Get help with drop-in workshops</a></h1> 

        <p>Library drop-in workshops are available to help you improve your library skills and to learn new technologies for managing your academic research. <b><a href="workshops.cfm">See Workshop Schedule</a></b></p>
	</div> 

                    <div class="quicklinks"> 
	<div id="librarynews1" class="quicklinks"> 
<img class="quicklinks displayed" src="images/worldcat.gif" alt="WorldCat Local" width="98"/>
        <h1><br /><a href="http://lbcc.worldcat.org" target="_blank">Get started with WorldCat</a></h1> 
