...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Long Beach City College Library > What's New in the Library</title>
...
h2#about-statement {
	...
	width: 470px;
	text-indent: -9999px;
	background: #183048 url(http://constitutioncenter.org/constitutiondayassets/images/h2-bg.gif) no-repeat top left;
}
</style>
</head>
    ...
    <div id="outer-content-container" class="container_16"> 
		<div id="content-container" class="container_16">  
			<div id="top-content">             	
              ...
              <div id="main-content">
				  <p class="breadcrumb">You are here: <a href="http://www.lbcc.edu" title="LBCC Home Page">LBCC Home</a> &raquo; <a href="index.cfm">LBCC Library Home</a> &raquo; What's New in the Library </p><br />                
                  <cfparam name="story" default="inc_list.cfm">
                  <cfoutput>
                  <cfinclude template="#story#">               
                  </cfoutput> 
                </div>
                </div> 
