...
border-top: 2px solid #e6e6d8!important;
border-bottom: 2px solid #e6e6d8!important;
}
#top-content {
background: #e6e6d8!important;
}
#libraryhours {
background: #e6e6d8!important;
}
...
#books {/*border:1px dashed #090909; background-color:#fff;*/width:160px; background-image:url('images/new_index/book_red_line.png'); background-repeat:no-repeat;margin-left:10px;}
/*a:hover #books {border:1px dashed #bbb;background-image:url('images/new_index/book_gray_light.png')}*/

#tbx {/*border:1px dashed #090909;background-color:#fff;*/width:110px; background-image:url('images/new_index/txbks_red_line.png'); background-repeat:no-repeat; }
/*a:hover #tbx {border:1px dashed #bbb;background-image:url('images/new_index/txbks_gray_light.png')}*/
#art {/*border:1px dashed #090909;background-color:#fff;*/width:160px;background-image:url('images/new_index/art_red_line.png'); background-repeat:no-repeat;}
/*a:hover #art {border:1px dashed #bbb;background-image:url('images/new_index/art_gray_light_alt.png')}*/
#gdes {/*border:1px dashed #090909;background-color:#fff;*/width:160px;background-image:url('images/new_index/gdes_red_line.png'); background-repeat:no-repeat;margin-left:-10px; }
