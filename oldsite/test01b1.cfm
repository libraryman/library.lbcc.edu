...
#books {background-color:#090909;width:160px; background-image:url('images/new_index/book_solid.png'); background-repeat:no-repeat;margin-left:10px;}
#tbx {background-color:#090909;width:110px; background-image:url('images/new_index/txbks_solid.png'); background-repeat:no-repeat; }
#art {background-color:#090909;;width:160px;background-image:url('images/new_index/art_solid_alt.png'); background-repeat:no-repeat;}
#gdes {background-color:#090909;width:160px;background-image:url('images/new_index/gdes_solid.png'); background-repeat:no-repeat;margin-left:-10px; }
