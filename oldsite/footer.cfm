...
<div id="belowfooter-container">
	<div id="belowfooter">
        ...
        <div id="belowfooter-center3" class="grid_3">
        	<p><a href="http://lbcc.libanswers.com">Frequently Asked Questions</a></p>
        </div> 
        ...
        <div id="belowfooter-center2" class="grid_15" align="center">
         <cfdirectory action="list"
    		...
    		<cfoutput><p>Last updated #DateFormat(qGetLastdateModified.dateLastModified, "mm/dd/yyyy")#</p></cfoutput>
			</cfif>
        </div>
        <div class="clear">&nbsp;</div>       
	</div>               
