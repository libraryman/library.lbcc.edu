...
<div class="tabbertab" id="mytab3">
    ...
    <div id='api_searchbox_iid927'></div><script type='text/javascript' src='http://api.libguides.com/api_searchbox.php?iid=927&amp;context=object&amp;format=js'> </script>
    	<p><br /><br /><br /></p>
                        ...
                        <div class="quicklinks" style="background:url('images/asl.png') rgb(255, 255, 255) no-repeat;background-color: #FFF;background-position:center;"> 

<h1>LIBRARY Workshops with Sign Language Interpreters</h1>
    <div style="float:right;width:200px;"><h2>Friday, March 27th<br />LAC CAMPUS <br />ROOM L-103<br /><br /></h2>
    <ul><li><b>9-10:30 am:</b><br /> Library Resources Workshop</li><hr />
    <li><b>12:00-1 pm:</b><br /> Missing: Sources for Your Paper Workshop</li>
    </ul>
        <br />
    </div>
...
<p>All students are welcome to attend!</p>

<p>Not sure how to begin your research? Bring
your assignment(s) and we will help you.
Both workshops take place in L103.
<b>American Sign Language Interpreters will be
available to assist deaf students.</b></p>

<p><b><a href="pdf/march27Workshop.pdf">Download Flyer for more information</a></b></p>


    <div class="quicklinks"> 
		<br /><p><img class="quicklinks displayed" alt="Genealogy tree" src="images/workshops.jpg"  width="98"/></p>
        <h3><br /><br /><a href="workshops.cfm">Drop-in Workshops</a></h3> 
