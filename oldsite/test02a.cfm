...
#art {background-color:#fff;;width:160px;background-image:url('images/new_index/art_gray.png'); background-repeat:no-repeat;}
a:hover #art {background-image:url('images/new_index/art_gray_light.png')}
