...
<cfif form.authenticated eq 1>
<cfset session.authenticated = 1>
<cfelse>
	<cflocation url="https://onlinecounseling.lbcc.edu/securelogin/librarylogin.cfm" addtoken="No">
</cfif>

<cflock timeout="20" throwontimeout="no" type="exclusive" scope="session">
	<cfif NOT IsDefined("Session.authenticated")>
	<cflocation url="https://onlinecounseling.lbcc.edu/securelogin/librarylogin.cfm" addtoken="No">
	<cfelseif Session.authenticated IS "">
	<cflocation url="https://onlinecounseling.lbcc.edu/securelogin/librarylogin.cfm" addtoken="No">
	</cfif>
</cflock>
...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="../forms/forms.css" />
	<style type="text/css">
		label {
			width: 18em;
			}			
...
<div id="main-text">
 ...
 <!-- *************************** start of form   ************************************* --> 
  ...
  <cfform name="myform" action="../forms/components/emailref.cfc?method=emailinformation" onsubmit="return validate();" method="post">        
  ...
  <fieldset>
    ...
    <p>
    <label for="id">Student I.D. Number:<span class="required">*</span></label>
