(function($) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      username: ["lbcclibrary"],                // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
      ...
      template: function(info) {                // [function] template used to construct each tweet <li>
        return info["join"] + info["text"] + info["time"]; 
      },
