...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Long Beach City College Library > Parking &amp; Campus Maps</title>
    ...
    <div id="outer-content-container" class="container_16"> 
		<div id="content-container" class="container_16">  
			<div id="top-content">             	
              ...
              <div id="main-content">
				  <p class="breadcrumb">You are here: <a href="http://www.lbcc.edu" title="LBCC Home Page">LBCC Home</a> &raquo; <a href="index.cfm">LBCC Library Home</a> &raquo; ABOUT &raquo; Finding the Library</p><br />
                  <h1>Finding the Library</h1>   
                   <ol class="mycontentlist">                  	
                   <li class="mycontentlistitem"><a href="hours.cfm" title="Library Hours"><strong>Current Library Hours</strong></a></li>
                   <li class="mycontentlistitem"><a href="contact.cfm" title="Contact Us" target="_blank"><strong>Contact Us</strong></a></li>
                   </ol>
                  <h3>Getting to the LAC Campus Library</h3>
                  <p>4901 E. Carson Street Long Beach, CA 90808</p><br />
                  <p>The library is located in Building L (circled in red on the following map), which is north of Carson Street and off of Faculty Avenue. The entrance to the library is on the east side, facing the lawn area.</p><br />
				  <p>Student parking is available in Lots D, E, F, G and H.</p><br />
                  <img src="images/lacmap.jpg" alt="LAC Campus Map" />
                  </p>                    
                  <h3>Getting to the PCC Campus Library</h3>
                  <p>1305 E. Pacific Coast Highway Long Beach, CA 90806</p><br />
                  <p>The library is located in Building LL (circled in red on the following map), which is off of Pacific Coast Highway and May Avenue (between Orange and Walnut). The entrance to the library is on the north side of the building.</p><br />				  
                  <img src="images/pccmap.jpg" alt="PCC Campus Map" />
                  </p>  
                </div>
                </div> 
