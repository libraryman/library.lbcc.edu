...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Long Beach City College Library Services > Computers & Printing</title>
...
<body class="front not-logged-in page-node no-sidebars">
	xx
<cfinclude template="http://lib.lbcc.edu/new2011/topnav.cfm">
yyy
...
<!--BEGIN MAIN CONTENT & RIGHT NAV -->
		...
		<div id="content-container" class="container_16">  
			<div id="top-content">             	
			  <div id="generalcontent"  class="grid_11 alpha"> 				<div id="main-content">
				  <p class="small"><a href="http://www.lbcc.edu" title="LBCC Home Page">LBCC</a> > <a href="../index.cfm">Library Home</a> > Student Services > Computers &amp; Printing</p><br />
                <h1>Computers &amp; Printing</h1>   
                  <p>Computers for Internet research use and subscription database searching are available at both campuses from the opening of the Library until 15 minutes prior to closing.</p>
                    <h3>LAC Library Research Center</h3>
                    <p>Research computers at the LAC Library (Building L, first floor Room 131) with printer access are available for academic use only to currently registered LBCC students. Additional computers are available in the <a href="http://www.lbcc.edu/LAR/computerlabs.cfm">Academic Computing Center</a> located on the top floor of the L building in Room 251, upstairs from the library.</p>
                    <h3>PCC Library Research Center</h3>
                    <p>Computers for research and academic work are available at the PCC Library (Building L, first floor) located near the entrance of the Library in Room 122. There are also computers available for research and word processing on the 2nd floor in the Academic Computing Center in Room 216.</p>
                </div>
                </div> xx
			<cfinclude template="http://lib.lbcc.edu/new2011/rightnavstandard.cfm">
			</div>		
		<div class="clear"> </div>
	...
	<cfinclude template="http://lib.lbcc.edu/new2011/footer.cfm">
