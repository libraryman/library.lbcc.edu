...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Long Beach City College Library > About > Policies &amp; Request Forms</title>
    ...
    <div id="outer-content-container" class="container_16"> 
		<div id="content-container" class="container_16">  
			<div id="top-content">             	
              ...
              <div id="main-content">
				  <p class="breadcrumb">You are here: <a href="http://www.lbcc.edu" title="LBCC Home Page">LBCC Home</a> &raquo; <a href="index.cfm">LBCC Library Home</a> &raquo; ABOUT &raquo; Policies & Request Forms</p><br />                <h1>Policies & Request Forms</h1>                  
                  <p></p>
                  <h3>Faculty Request Forms</h3>
                  <ol class="mycontentlist">
			    	<li class="mycontentlistitem"><a href="http://lib.lbcc.edu/forms/orientation.cfm" target="_blank">Library Orientation Request (Faculty)</a></li>
			     	<li class="mycontentlistitem"><a href="http://lib.lbcc.edu/forms/reserveform.cfm" target="_blank">Place Item on Course Reserve (Faculty)</a></li>
                  </ol>
                  <h3>Interlibrary Loan (ILL) Request Forms</h3>
                  <ol class="mycontentlist">
                  	<li class="mycontentlistitem"><a href="http://lib.lbcc.edu/forms/ill-bookform.cfm" target="_blank">Interlibrary Loan Book Request (Students, Faculty & Staff)</a></li>
                    <li class="mycontentlistitem"><a href="http://lib.lbcc.edu/forms/ill-articleform.cfm" target="_blank">Interlibrary Loan Article Request (Students, Faculty & Staff)</a></li>                    
                  </ol> 
                  <h3>General Forms</h3>
                  <ol class="mycontentlist">
                  	<li class="mycontentlistitem"><a href="http://lib.lbcc.edu/forms/libsugform.cfm" target="_blank">Library Suggestion</a></li>
                  </ol>
                  <h3>Library Policies</h3>
                  <ol class="mycontentlist">
			    	<li class="mycontentlistitem"><a href="illborrowpolicy.cfm">Interlibrary Loan (ILL) Borrowing Policy</a></li>
			     	<li class="mycontentlistitem"></li>
                  </ol> 
