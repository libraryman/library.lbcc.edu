...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Long Beach City College Library > E-books</title>
    ...
    <div id="outer-content-container" class="container_16"> 
		<div id="content-container" class="container_16">  
			<div id="top-content">             	
              ...
              <div id="main-content">
				  <p class="breadcrumb">You are here: <a href="http://www.lbcc.edu" title="LBCC Home Page">LBCC Home</a> &raquo; <a href="index.cfm">LBCC Library Home</a> &raquo; FIND &raquo; E-books</p><br />
                <h1>E-books</h1>   
                  <p>Full-text electronic books and reference materials are now available through <a href="http://lbcc.worldcat.org" target="_blank">WorldCat</a>, our online catalog. We offer several resources to search for e-books.</p>
                  <h3><a title="E-books" href="http://search.ebscohost.com/login.aspx?authtype=ip,uid&profile=ehost&defaultdb=nlebk" target="_blank">E-books by EBSCOhost</a></h3>
                  <p>Over 11,000 e-books are available through <a href="http://search.ebscohost.com/login.aspx?authtype=ip,uid&profile=ehost&defaultdb=nlebk" target="_blank"><strong>EBSCOhost e-books</strong></a>. These books can be read online through your browser, while small sections of the book can be downloaded (and printed) as a PDF document or downloaded to an approved e-reader.</p>
                 <h3><a title="Gale Virtual Reference Library" href="http://infotrac.galegroup.com/itweb/cclc_lbcc?db=GVRL" target="_blank">Gale Virtual Reference</a></h3>
                 <p>Access to over 150 e-book reference titles representing the following subjects: Arts, Business, Environment, History, Law, Literature, Medicine, Multicultural Studies, Nation and World, Science, Social Science, and Technology is available for searching within <a href="http://infotrac.galegroup.com/itweb/cclc_lbcc?db=GVRL" target="_blank"><strong>Gale Virtual Reference</strong></a>.</p><br />   
                 <h1>E-book Tutorials</h1>
                <br />
                 <iframe width="315" height="236" src="http://www.youtube.com/embed/aS2c0L1si2E" frameborder="0" allowfullscreen></iframe>
