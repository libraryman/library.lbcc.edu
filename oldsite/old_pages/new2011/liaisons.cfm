...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Long Beach City College Library > Faculty Liaisons</title>
    ...
    <div id="outer-content-container" class="container_16"> 
		<div id="content-container" class="container_16">  
			<div id="top-content">             	
              ...
              <div id="main-content">
				  <p class="breadcrumb">You are here: <a href="http://www.lbcc.edu" title="LBCC Home Page">LBCC Home</a> &raquo; <a href="index.cfm">LBCC Library Home</a> &raquo; SERVICES &raquo; Faculty Liaisons</p><br />
                <h1>Faculty Liaisons</h1>   
                  <p>Your liaison will help you purchase books you would like to see in the collection, add Web pages to help students, and other programs to improve library services. We are happy to teach an individual instructor or an entire department about library tools and resources, or answer a question you might have. Please let us know how we can better serve you and your departments.</p><br />

                <table class="grid" summary="This table lists the names of librarians and the schools with which they liaise">     	

        <thead>
        	<tr>
        		<th>School/Area</th>
        		<th>Library Liaison</th>
        	</tr> 
        </thead>
        <tbody>        
          	<tr>
          		<td>School of Business &amp; Social Science</td>
          		<td><a title="Dena Laney" href="laney.cfm">Dena Laney</a></td>
        	</tr>
        	<tr> 
          		<td>School of Creative Arts &amp; Applied Sciences</td>
          		<td><a title="Kim Barclay" href="barclay.cfm">Kim Barclay</a></td>
        	</tr>
        	<tr> 
          		<td>School of Health &amp; Science</td>
          		<td><a title="Nenita Buenaventura" href="buena.cfm">Nenita B. Buenaventura</a></td>
        	</tr>
        	<tr> 
          		<td>School of Language Arts<br />School of Physical Education &amp; Athletics</td>
          		<td><a title="Celina Lee" href="lee.cfm">Celina Lee</a></td>
        	</tr>
        	<tr> 
          		<td>Student Success Centers</td>
          		<td><a title="Dele Ukwu" href="ukwu.cfm">Dele C. Ukwu</a></td>
        	</tr>
        	<tr> 
          		<td>All Pacific Coast Campus Departments and Faculty, including the School of Trades &amp; Industrial Technology</td>
          		<td><a title="Ramchandran Sethuraman" href="seth.cfm">Ramchandran Sethuraman</a></td>
        	</tr>
        </tbody>
      </table>
