...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>LBCC Library Off Campus Access</title>
    ...
    <div id="outer-content-container" class="container_16"> 
		<div id="content-container" class="container_16">  
			<div id="top-content">             	
              ...
              <div id="main-content">
				  <p class="breadcrumb">You are here: <a href="http://www.lbcc.edu" title="LBCC Home Page">LBCC Home</a> &raquo; <a href="index.cfm">LBCC Library Home</a> &raquo; HELP &raquo; Off Campus Access</p><br />
                	<h1>Off Campus Access</h1>   
                    <p>Access to the library's electronic resources is available only to current students, faculty, and staff per our licensing agreements.<br /><br />
                    Off campus users must first authenticate with the library to use these subscription-based resources.<br /><br />
                  	After successfully logging in, you will be routed to the list of databases with off campus access.<br /><br />
					Please help us ensure security to our licensed resources by not sharing your login information with others.</p> 
					<h3><a href="" title="Student Login">Student Login</a></h3>
                    <p>Currently enrolled students can access library databases by logging in with their student id number and last name. If you do not know your student id number contact the Registrar's Office at (562) 938-4485.</p>                    
					<h3><a href="" title="Faculty/Staff Login">Faculty and Staff Login</a></h3>
                    <p>Faculty and staff can access our databases with their network login and password. If you do not have a network login, please contact ACIT for instructions on requesting a network login.</p>                           
                </div>
                </div> 
