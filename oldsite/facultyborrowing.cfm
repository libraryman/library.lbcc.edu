...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Long Beach City College Library Instruction > Faculty Borrowing & Renewing</title>
    ...
    <div id="outer-content-container" class="container_16"> 
		<div id="content-container" class="container_16">  
			<div id="top-content">             	
              ...
              <div id="main-content">
				  <p class="breadcrumb">You are here: <a href="http://www.lbcc.edu" title="LBCC Home Page">LBCC Home</a> &raquo; <a href="index.cfm">LBCC Library Home</a> &raquo; SERVICES &raquo; Faculty Borrowing & Renewing</p><br />
                <h1>Faculty Borrowing & Renewing</h1>   
                  <p>Books generally circulate to faculty for 120 days; faculty loans are subject to recall when there are other requests for the materials. Check <a href="http://voyager2.lbcc.edu/vwebv/login" target="_blank">Voyager</a> and view "My Record" to determine what materials are checked out to you.<br /><br />
                  The Long Beach City College Libraries have a reciprocal borrowing agreement with the University Library at California State University Long Beach enabling eligible students, faculty, staff, and administrators to use both library systems. Please visit <a href="http://www.csulb.edu/library/guide/Reciprocal_Borrowers.html" target="_blank">CSULB's Information Guide for Reciprocal Borrowers web page</a> for details and the established guidelines.<br /><br />
                 Review our <a href="borrowing.cfm">Borrowing Frequently Asked Questions (FAQ's)</a> for more information.</p>
