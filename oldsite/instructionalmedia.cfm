...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Long Beach City College Library Instruction > Instructional Media</title>
    ...
    <div id="outer-content-container" class="container_16"> 
		<div id="content-container" class="container_16">  
			<div id="top-content">             	
              ...
              <div id="main-content">
				 <p class="breadcrumb">You are here: <a href="http://www.lbcc.edu" title="LBCC Home Page">LBCC Home</a> &raquo; <a href="index.cfm">LBCC Library Home</a> &raquo; SERVICES &raquo; Instructional Media</p><br />
                <h1>Instructional Media</h1>   
                  <p>
                  Please visit <a href="http://lbccinstmedia.weebly.com/" target="_blank">http://lbccinstmedia.weebly.com/</a> for the instructional media section of our website.
                  </p>
                 
                  <!--  <ol class="mycontentlist">    
                    	<li class="mycontentlistitem"><a href="http://lib.lbcc.edu/documents/LibraryMediaDVD.pdf" target="_blank">Instructional Media Collection DVD Catalog</a></li>
                        <li class="mycontentlistitem"><a href="http://lib.lbcc.edu/documents/LibraryMediaCatalogFall09.pdf" target="_blank">Instructional Media Collection VHS Catalog</a></li>         
                   	</ol> -->
