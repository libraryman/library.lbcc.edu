...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Long Beach City College Library Instruction > Contact Us</title>
    ...
    <div id="outer-content-container" class="container_16"> 
		<div id="content-container" class="container_16">  
			<div id="top-content">             	
              ...
              <div id="main-content">
				  <p class="breadcrumb">You are here: <a href="http://www.lbcc.edu" title="LBCC Home Page">LBCC Home</a> &raquo; <a href="index.cfm">LBCC Library Home</a> &raquo; HELP &raquo; Contact Us</p><br />
                <h1>Contact Us</h1>   
                	<ol class="mycontentlist">
                  	<li class="mycontentlistitem"><a href="askalibrarian.cfm"><strong>Ask A Librarian</strong></a></li>
                   <li class="mycontentlistitem"><a href="hours.cfm"><strong>Library Hours</strong></a></li>
                   <li class="mycontentlistitem"><a href="campusmaps.cfm"><strong>Library Location</strong></a></li>
                   </ol>
                   <!-- <p>By using the form below, your suggestion, question or feedback will automatically be directed to the appropriate department.</p><br /> -->
					<p>Or if you prefer, please feel free to call us using one of the following numbers:</p><br />
					<table class="grid" summary="This table lists contact information for PCC and LAC libraries">
                        <thead>
                            <tr>
                                <th>Liberal Arts Campus (LAC)</th>        
                                <th>Pacific Coast Campus (PCC)</th>
                            </tr>
                        </thead>
                        <tbody>					 
                            <tr>
                            <td width="50%">4901 East Carson Street<br />
					Long Beach, California 90808<br /></td>
                            <td>1305 East Pacific Coast Highway<br />
					Long Beach, California 90806</td>
                            </tr>
                             <tr>
                            <td>
                            Circulation Desk: (562) 938-4231<br />
					Reference Desk (Ask a Librarian): (562) 938-4232<br /></td>
                            <td>Circulation Desk: (562) 938-3029<br /> 
                    Reference Desk (Ask a Librarian): (562) 938-3028<br />
                   <!-- Research Center Computer Lab: (562) 938-3261 --></td>
                            </tr>
                        </tbody>
                        </table> 
