...
<head>
	...
	<title>Book Purchase Suggestion</title>
...
<h1>Library Forms:<br />Book Purchase Suggestion</h1>
  
<h2 class="clear">Book Purchase Suggestion</h2> 

<div id="main-text">

<p>Please use a separate request form for each book. Use this form to suggest the purchase of a book or a subject area needed in the LBCC Library.
Please keep in mind that all suggestions are subject to availability of funds.</p>
 ...
 <!-- *************************** start of form   ************************************* --> 
  ...
  <cfform name="myform" action="components/booksuggest.cfc?method=emailinformation" onsubmit="return validate();" method="post">        
  
  <fieldset>
  	<legend><strong><span class="underline">B</span>ook Information</strong> (accesskey: b)</legend>
  	
  	<p>Purchase is suggested for:</p>
  	<p>
  	<input type="radio" class="radio" checked="checked" name="campus" id="LAC" value="LAC" />
  	<label for="LAC" accesskey="b">LAC</label>
  	...
  	<p class="clear">Additional Comments:</p>
    <textarea name="comments" id="comments" rows="6" cols="51">Please enter additional comments</textarea>
    <br /><br /><br />
