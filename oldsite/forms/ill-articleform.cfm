...
<head>
	...
	<title>Interlibrary Loan Article Request Form</title>
	...
	<!-- Form parameters -->	
		...
		<cfparam name="journal" default="" type="string" />
		<cfparam name="volume" default="" type="string" />
		<cfparam name="issue" default="" type="string" />
		<cfparam name="year" default="" type="string" />
		<cfparam name="issn" default="" type="string" />
...
<h1>Library Forms:<br />Interlibrary Article Request</h1>
  
<h2 class="clear">Interlibrary Loan Article Request</h2> 

<div id="main-text">

<p>Please use a separate request form for each book.</p>

<p>Use this form to request magazine and journal articles which are not in LBCC Library or on Proquest. Please provide the requested information when prompted for it. Materials usually take from two to four weeks arrive.</p>
 ...
 <!-- *************************** start of form   ************************************* --> 
  ...
  <cfform name="myform" action="components/ill-articleform.cfc?method=emailinformation" onsubmit="return validate();" method="post">        
  
  <fieldset>
  	<legend><strong><span class="underline">A</span>rticle Information</strong> (accesskey: a)</legend>
  
  	<p>
  	<label for="author" accesskey="a">Author:</label>
  	<input name="author" id="author" type="text" value="Enter the author's name here" />
  	</p>
  	...
  	<p>
  	<label for="journal">Title of Journal/Magazine:</label>
  	<input name="journal" id="jornal" type="text" value="Enter the journal title here" />
  	</p>
  	
  	<p>
  	<label for="volume">Volume:</label>
  	<input name="volume" id="volume" type="text" value="Enter the volume number here" />
  	</p>
  	
  	<p>
  	<label for="issue">Issue Number:</label>
  	<input name="issue" id="issue" type="text" value="Enter the issue number here" />
  	</p>
  	
  	<p>
  	<label for="year">Year:</label>
  	<input name="year" id="year" type="text" value="Enter the publication year here" />
  	</p>
  	
  	<p>
  	<label for="issn">ISSN (if known):</label>
  	<input name="issn" id="issn" type="text" value="Enter the issn here" />
  	</p>
  	
  	<p>
  	<label for="page">Page Number:</label>
  	<input name="page" id="page" type="text" value="Enter the page numbers here" />
  	</p>
  	
  	 <label for="comments">Additional Comments:</label>
    <textarea name="comments" id="comments" rows="6" cols="51">Please enter additional comments here</textarea>    
    <br /><br />
...
<fieldset>
    ...
    <label for="checkbox4">I agree to comply with these restrictions. <strong>(Failure to check this box will cancel your 
    request.)</strong></label><br />
    </div>
</fieldset>
