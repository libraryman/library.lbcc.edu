...
<cfparam name="form.comments" default="" type="string">
	...
	<!--- Mail Section --->
	   	<cfmail to="pcclibrary@lbcc.edu, kbarclay@lbcc.edu" from="liborient@lbcc.edu" replyto="kbarclay@lbcc.edu" subject="Request for PCC Campus orientation from #form.name#" type="html">
		<p> <font color="##000000" size="3" face="Arial, Helvetica, sans-serif">You have a request for a PCC Library orientation.</font></p>  
