...
<cfparam name="form.checkbox3" default="" type="string">
	...
	<!--- Mail Section --->
	   	<cfmail to="lbcclibrary@gmail.com" from="#form.email#" subject="Request Journal Issue from Other Campus from #form.name#" type="html">
		<p> <font color="##333333" size="4" face="Arial, Helvetica, sans-serif"> You have a request to transfer a journal issue from one campus to the other. </font></p>  
		<table width="600" border="0" cellspacing="3" cellpadding="3">
			  ...
			  <tr bgcolor="##ffffff">
					<td align="left" width="250"><font color="##000000" size="4" face="Arial, Helvetica, sans-serif">Journal Title:</font></td>
					<td align="left" width="350"><font color="##820204" size="4" face="Arial, Helvetica, sans-serif">#form.title#</font></td>
			  </tr>
			  <tr bgcolor="##ffffff">
					<td align="left" width="250"><font color="##000000" size="4" face="Arial, Helvetica, sans-serif">Volume and Issue Number:</font></td>
					<td align="left" width="350"><font color="##820204" size="4" face="Arial, Helvetica, sans-serif">#form.volume#</font></td>
			  </tr>
			   <tr bgcolor="##ffffff">
					<td align="left" width="250"><font color="##000000" size="4" face="Arial, Helvetica, sans-serif">Date:</font></td> 
