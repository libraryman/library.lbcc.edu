...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Long Beach City College Library Services > Textbook Reserves</title>
    ...
    <div id="outer-content-container" class="container_16"> 
		<div id="content-container" class="container_16">  
			<div id="top-content">             	
              ...
              <div id="main-content">
				   <p class="breadcrumb">You are here: <a href="http://www.lbcc.edu" title="LBCC Home Page">LBCC Home</a> &raquo; <a href="index.cfm">LBCC Library Home</a> &raquo; SERVICES &raquo; Textbooks on Reserve</p><br />	
                <h1>Textbooks on Reserve</h1>   
                  <p>The LAC and PCC Libraries maintain a small selection of specific books, periodical articles, and other materials which faculty require students to read for a particular course. These materials are set aside for short term use in the library and are available for checkout at the reserve desk.</p>
                    <h3>LAC Library </h3>
                    <p>The Reserve Desk at the LAC campus library is in the Reserve Room just inside the entrance of the library, across from the Reference Desk.</p>
                    <h3>PCC Library </h3>
                    <p>The Reserve Desk at the PCC campus library is located along side of the Circulation (borrowing) Desk of the Library.</p>
               		<h3>Find Your Textbook</h3>
                    <p><a href="http://lbcc.bncollege.com/">LBCC Viking Bookstore</a></p>
                    <p><a href="http://lbcc.worldcat.org/wcpa/courseReserves?action=courseReserveManager" target="_blank">Search WorldCat for Textbooks on Reserve</p>
                </div>
                </div> 
