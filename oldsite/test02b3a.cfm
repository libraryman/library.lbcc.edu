...
.bigbutton h1 {margin-left:5px;line-height:130px;font-weight:100; font-size:1.2em;}
a:hover .bigbutton h1{color:#efefef}
a:visited .bigbutton h1{color:#efefef} 
...
#books {background-color:#ee2d24;width:160px; background-image:url('images/new_index/book_solid.png'); background-repeat:no-repeat;margin-left:10px;}
a:hover #books {background-image:url('images/new_index/book_gray_light_center.png')}

#tbx {background-color:#ee2d24;width:110px; background-image:url('images/new_index/txbks_solid.png'); background-repeat:no-repeat; }
#art {background-color:#ee2d24;width:160px;background-image:url('images/new_index/art_solid_alt.png'); background-repeat:no-repeat;}
#gdes {background-color:#ee2d24;width:160px;background-image:url('images/new_index/gdes_solid.png'); background-repeat:no-repeat;margin-left:-10px; }
    </style>
</head>
